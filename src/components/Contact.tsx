      ...
      <div className="relative z-10 grid gap-12 md:grid-cols-12">
          ...
          <div className="mt-10 space-y-2.5">
            {channels.map((c, i) => (
              <motion.a
                ...
                className="group flex items-center gap-4 rounded-2xl border border-foreground/10 bg-background/70 px-5 py-4 backdrop-blur-sm transition-all hover:border-[oklch(0.62_0.22_280/0.35)] hover:bg-[oklch(0.97_0.04_280/0.5)] hover:shadow-[0_4px_24px_oklch(0.62_0.22_280/0.10)]"
              >
                <span
                  className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-sm transition-colors group-hover:bg-[oklch(0.62_0.22_280)] group-hover:text-white"
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-0.5 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
                  ...
                  <span className="truncate font-display text-sm tracking-tight transition-colors group-hover:text-[oklch(0.44_0.22_280)]">
                    {c.value}
                  </span>
                </div>
                <span className="shrink-0 text-foreground/30 transition-all group-hover:translate-x-0.5 group-hover:text-[oklch(0.62_0.22_280)]">
                  ↗
                </span>
              </motion.a>
            ))}
        ...
        <FadeIn delay={0.1} className="md:col-span-7">
          <motion.form
            ...
            className="relative overflow-hidden rounded-3xl border border-foreground/10 p-8 shadow-[var(--shadow-glow)] backdrop-blur-md"
            style={{
              background: "linear-gradient(135deg, rgba(255,255,255,0.88) 0%, oklch(0.97 0.03 280 / 0.5) 100%)",
            }}
          >
            {/* Terminal title bar */}
            <div className="absolute inset-x-0 top-0 flex items-center justify-between border-b border-foreground/8 px-6 py-3 font-mono text-[10px] uppercase tracking-[0.3em] text-foreground/50">
              ...
              <span className="hidden sm:inline">secure-channel://manan.agrawal</span>
              <span>2035</span>
            </div>
